...
$(function() {
    ...
    function scrollDownAnimate() {
        $scrollDown
            .animate({ bottom: "35px" }, 1000, "easeOutSine")
            .animate({ bottom: "15px" }, 1000, "easeOutSine", scrollDownAnimate);
    }
    function cvAnimate() {
        $cv
            .animate({ bottom: "75px" }, 1000, "easeOutSine")
            .animate({ bottom: "55px" }, 1000, "easeOutSine", cvAnimate);
    }
    scrollDownAnimate();
    cvAnimate();
